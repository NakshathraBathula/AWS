...
Here copy the ssh 鈥� i command from SSH client connect tab and paste later
...
sudo docker build 鈥搕 mywebapp .
sudo docker run 鈥揹 鈥損 80:80 mywebapp
Go to instances and click on instance here
Copy public ipv4 address
Paste it in the browser to get below output
Note : if https :__ won鈥檛 work then type just http:___
------------------------------------------------------------------------------------------------------------------------------------------------------------
...
鈹溾攢鈹€ Click on "New Item" (left

STEP2:Create Freestyle Project (e.g., MavenJava_Build)
鈹溾攢鈹€ Enter project name (e.g., MavenJava_Build)
鈹溾攢鈹€ Click "OK" 鈹斺攢鈹€ Configure the project:
鈹溾攢鈹€ Description: "Java Build demo" 鈹溾攢鈹€ Source Code Management:
鈹斺攢鈹€ Git repository URL: [GitMavenJava repo URL]
鈹溾攢鈹€ Branches to build: */Main or */master
鈹斺攢鈹€ Build Steps:
鈹溾攢鈹€ Add Build Step -> "Invoke top-level Maven targets" 鈹斺攢鈹€ Maven version: MAVEN_HOME
鈹斺攢鈹€ Goals: clean
鈹溾攢鈹€ Add Build Step -> "Invoke top-level Maven targets" 鈹斺攢鈹€ Maven version: MAVEN_HOME
鈹斺攢鈹€ Goals: install
鈹斺攢鈹€ Post-build Actions:
鈹溾攢鈹€ Add Post Build Action -> "Archive the artifacts" 鈹斺攢鈹€ Files to archive: **/*
鈹溾攢鈹€ Add Post Build Action -> "Build other projects" 鈹斺攢鈹€ Projects to build: MavenJava_Test
鈹斺攢鈹€ Trigger: Only if build is stable
鈹斺攢鈹€ Apply and Save

Step 3: Create Freestyle Project (e.g., MavenJava_Test)
鈹溾攢鈹€ Enter project name (e.g., MavenJava_Test)
鈹溾攢鈹€ Click "OK" 鈹斺攢鈹€ Configure the project:
鈹溾攢鈹€ Description: "Test demo" 鈹溾攢鈹€ Build Environment:
鈹斺攢鈹€ Check: "Delete the workspace before build starts" 鈹溾攢鈹€ Add Build Step -> "Copy artifacts from another project" 鈹斺攢鈹€ Project name: MavenJava_Build
鈹斺攢鈹€ Build: Stable build only // tick at this
鈹斺攢鈹€ Artifacts to copy: **/*
鈹溾攢鈹€ Add Build Step -> "Invoke top-level Maven targets" 鈹斺攢鈹€ Maven version: MAVEN_HOME
鈹斺攢鈹€ Goals: test
鈹斺攢鈹€ Post-build Actions:
鈹溾攢鈹€ Add Post Build Action -> "Archive the artifacts" 鈹斺攢鈹€ Files to archive: **/*
...
鈹斺攢鈹€ Step 4: Create Pipeline View for Maven Java project
鈹溾攢鈹€ Click "+" beside "All" on the dashboard
鈹溾攢鈹€ Enter name: MavenJava_Pipeline
鈹溾攢鈹€ Select "Build pipeline view" // tick here
|--- create
鈹斺攢鈹€ Pipeline Flow:
鈹溾攢鈹€ Layout: Based on upstream/downstream relationship
鈹溾攢鈹€ Initial job: MavenJava_Build
鈹斺攢鈹€ Apply and Save Ok
===========================

WEB PROJECT:

 Step 1: Open Jenkins (localhost:8080)
鈹溾攢鈹€ Click on "New Item" (left side menu)

 Step 2: Create Freestyle Project (e.g., MavenWeb_Build)
鈹溾攢鈹€ Enter project name (e.g., MavenWeb_Build)
鈹溾攢鈹€ Click "OK" 鈹斺攢鈹€ Configure the project:
鈹溾攢鈹€ Description: "Web Build demo" 鈹溾攢鈹€ Source Code Management:
鈹斺攢鈹€ Git repository URL: [GitMavenWeb repo URL]
鈹溾攢鈹€ Branches to build: */Main or master
鈹斺攢鈹€ Build Steps:
鈹溾攢鈹€ Add Build Step -> "Invoke top-level Maven targets" 鈹斺攢鈹€ Maven version: MAVEN_HOME
鈹斺攢鈹€ Goals: clean
...
鈹斺攢鈹€ Post-build Actions:
鈹溾攢鈹€ Add Post Build Action -> "Archive the artifacts" 鈹斺攢鈹€ Files to archive: **/*
鈹溾攢鈹€ Add Post Build Action -> "Build other projects" 鈹斺攢鈹€ Projects to build: MavenWeb_Test
鈹斺攢鈹€ Trigger: Only if build is stable
鈹斺攢鈹€ Apply and Save

 Step 3: Create Freestyle Project (e.g., MavenWeb_Test)
鈹溾攢鈹€ Enter project name (e.g., MavenWeb_Test)
鈹溾攢鈹€ Click "OK" 鈹斺攢鈹€ Configure the project:
鈹溾攢鈹€ Description: "Test demo"
鈹溾攢鈹€ Build Environment:
鈹斺攢鈹€ Check: "Delete the workspace before build starts" 鈹溾攢鈹€ Add Build Step -> "Copy artifacts from another project" 鈹斺攢鈹€ Project name: MavenWeb_Build
鈹斺攢鈹€ Build: Stable build only
鈹斺攢鈹€ Artifacts to copy: **/*
鈹溾攢鈹€ Add Build Step -> "Invoke top-level Maven targets" 鈹斺攢鈹€ Maven version: MAVEN_HOME
鈹斺攢鈹€ Goals: test
鈹斺攢鈹€ Post-build Actions:
鈹溾攢鈹€ Add Post Build Action -> "Archive the artifacts" 鈹斺攢鈹€ Files to archive: **/*
鈹溾攢鈹€ Add Post Build Action -> "Build other projects" 鈹斺攢鈹€ Projects to build: MavenWeb_Deploy
鈹斺攢鈹€ Apply and Save

Step 4: Create Freestyle Project (e.g., MavenWeb_Deploy)
鈹溾攢鈹€ Enter project name (e.g., MavenWeb_Deploy)
鈹溾攢鈹€ Click "OK" 鈹斺攢鈹€ Configure the project:
鈹溾攢鈹€ Description: "Web Code Deployment"
鈹溾攢鈹€ Build Environment:
鈹斺攢鈹€ Check: "Delete the workspace before build starts" 鈹溾攢鈹€ Add Build Step -> "Copy artifacts from another project" 鈹斺攢鈹€ Project name: MavenWeb_Test
鈹斺攢鈹€ Build: Stable build only
鈹斺攢鈹€ Artifacts to copy: **/*
鈹斺攢鈹€ Post-build Actions:
鈹溾攢鈹€ Add Post Build Action -> "Deploy WAR/EAR to a container" 鈹斺攢鈹€ WAR/EAR File: **/*.war
鈹斺攢鈹€ Context path: Webpath
鈹斺攢鈹€ Add container -> Tomcat 9.x remote
鈹斺攢鈹€ Credentials: Username: admin, Password: 1234 鈹€鈹€ Tomcat URL: https://localhost:8085/
鈹斺攢鈹€ Apply and Save

鈹€ Step 5: Create Pipeline View for MavenWeb
鈹溾攢鈹€ Click "+" beside "All" on the dashboard
鈹溾攢鈹€ Enter name: MavenWeb_Pipeline
鈹溾攢鈹€ Select "Build pipeline view" 鈹斺攢鈹€ Pipeline Flow:
鈹溾攢鈹€ Layout: Based on upstream/downstream relationship
鈹溾攢鈹€ Initial job: MavenWeb_Build
鈹斺攢鈹€ Apply and Save

Step 6: Run the Pipeline and Check Output
鈹溾攢鈹€ Click on the trigger 鈥淩UN鈥� to run the pipeline
Note:
...
鈹溾攢鈹€ Open Tomcat homepage in another tab
鈹溾攢鈹€ Click on the "/webpath" option under the manager app
